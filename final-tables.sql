...
CREATE TABLE Provide(id INTEGER,
                    amenities CHAR(32),
...
CREATE TABLE Host(host_id INTEGER, 
                  ...
                  PRIMARY KEY(host_id) 
                  FOREIGN KEY (host_country_code,host_city,host_neighborhood) REFERENCES Neighborhood(country_code,city,neighborhood) )
...
CREATE TABLE Country(country_code INTEGER,
                     country CHAR(32),
...
CREATE TABLE Listing(id INTEGER,
                     ...
                     FOREIGN KEY (accomodates) REFERENCES Accommodation(accomodates),
